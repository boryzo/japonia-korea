  ...
  destinations: {
    ...
    kansai: {
      ...
      days: [
        ...
        { date: "26.08", day: "Środa", title: "Kyoto: pocztówkowa Japonia", text: "Fushimi Inari wcześnie rano, Kiyomizu-dera, uliczki Higashiyamy i Gion wieczorem.", cost: "¥¥", pace: "dużo chodzenia", must: true, details: { image: "assets/images/osaka_days/kyoto.jpg", desc: "Startujemy bardzo wcześnie! Kyoto to historyczna perła. Zaczniemy od magicznego, ciągnącego się kilometrami szlaku tysięcy czerwonych bram torii w Fushimi Inari. Potem przejdziemy do wspaniałej świątyni Kiyomizu-dera z widokiem na miasto i przespacerujemy się tradycyjnymi uliczkami Gionu, gdzie można spotkać Gejsze.", transport: "Do Fushimi Inari jedziemy pociągiem Keihan ze stacji Yodoyabashi (lub Kyobashi) w Osace bezpośrednio do stacji Fushimi-Inari (ok. 45-50 min)." } },
