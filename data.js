...
window.TRIP_DATA = {
  ...
  destinations: {
    ...
    kansai: {
      ...
      days: [
        ...
        { date: "28.08", day: "Piątek", title: "Odpoczynek: Wybrzeże Suma", text: "Ostatni dzień działania JR Kansai Mini Pass. Relaks i odpoczynek na plaży Suma w pobliżu Kobe.", cost: "¥", pace: "lekko", details: { image: "assets/images/osaka_days/castle.jpg", desc: "Dzień odpoczynku od zgiełku miast. Wykorzystując wygasający Mini Pass, jedziemy na malownicze wybrzeże Suma (obok Kobe). Zrelaksujemy się na plaży, spróbujemy owoców morza i odpoczniemy przed drugą połową wyjazdu.", transport: "Pełen zasięg Mini Pass: bezlimitowy kurs pociągami JR Special Rapid z Teradacho bezpośrednio na wybrzeże Suma." } },
    ...
    seoul: {
      ...
      days: [
        { date: "30.08", day: "Niedziela", title: "Pierwszy wieczór w Korei", text: "Przylot, transfer, karty T-Money dla dzieci. Krótki wieczór w Dongdaemun.", cost: "₩₩", pace: "lekko", details: { image: "assets/images/seoul_days/dongdaemun.jpg", desc: "Z lotniska Incheon dojedziemy zwykłym pociągiem AREX bezpośrednio do centrum. Najważniejsze po wylądowaniu: idziemy do małego sklepu (CU/GS25) na lotnisku i pokazując paszporty, wyrabiamy zniżkowe karty T-Money dla dzieci! Potem zameldujemy się w hotelu i ruszymy na kolację.", transport: "Z ICN bierzemy tańszy, wolniejszy pociąg AREX (All-Stop Train) do Seoul Station, a stamtąd metro linii 4 (niebieska) do stacji Dongdaemun." } },
  ...
  todos: [
    ...
    { title: "Kupić JR Kansai Mini Pass", detail: "Zrobić to przed przyjazdem do Kansai. Bilet regionalny na 3 dni, ogromna oszczędność na Kioto/Nara/Kobe.", priority: "high", category: "transport" },
    { title: "Transfer NRT → 7House", detail: "Keisei Main Line do Keisei-Sekiya, następnie przejście (Ushida) na Tobu Skytree Line. Najtańsze i optymalne.", priority: "high", category: "transport" },
