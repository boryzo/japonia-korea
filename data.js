...
window.TRIP_DATA = {
  ...
  baggage: {
    ...
    warning: "Peach MM739 KIX → GMP: limit kabinowy to łącznie 2 sztuki na osobę do 7 kg. W rezerwacji jest 1 bagaż rejestrowany; nadajemy jedną wspólną walizkę, a jeśli kupimy dużą walizkę w Kioto/Osace, trafiają do niej pamiątki i cięższe rzeczy przed lotem do Seulu.",
    bags: [
  ...
  travelApps: {
    japan: [
      ...
      { name: "SmartEX", purpose: "Rezerwacja Shinkansenu Nozomi Tokio → Osaka.", priority: "must", url: "https://smart-ex.jp/en/lp/app/" },
  ...
  shopping: {
    ...
    tips: [
      "Dzień przyjazdu: konbini — przekąski dla dzieci, śniadanie na rano.",
      "Następnego dnia: normalny supermarket (np. Seiyu, E-mart) — kupuj duże, dwulitrowe butelki wody i herbaty (za ok. 100-150 JPY), a następnie przelewaj do termosów. Automaty uliczne są zbyt drogie przy czteroosobowej rodzinie!",
      "Wieczorem: supermarket po przecenione bento/sushi/gotowce (nawet 50% taniej ok. 19:30).",
  ...
  stays: {
    tokyo: { name: "7House", dates: "21–25.08", nights: 4, price: 1462, rating: "8.6", area: "Adachi-ku, Tokio", address: "Adachi-ku · okolice stacji Gotanno (dokładny adres w prywatnej notatce)", check: "15:00 / 11:00", image: "assets/images/hotels/7house.webp", bookingUrl: "https://www.booking.com/hotel/jp/narita-haneda-airport-is-convenient-quiet-homestay.html", mapUrl: "https://www.google.com/maps/search/?api=1&query=Gotanno%20Station%20Tokyo" },
    kansai: { name: "SunriseHouse TD501", dates: "25–30.08", nights: 5, price: 680.27, rating: "8.7", area: "Teradacho, Tennoji-ku, Osaka", address: "Teradacho, Tennoji-ku · okolice stacji JR Teradacho (dokładny adres w prywatnej notatce)", check: "16:00 / 10:00", image: "assets/images/hotels/sunrisehouse.webp", bookingUrl: "https://www.booking.com/hotel/jp/nearest-jr-teradacho-station-3-minutes-on-foot-direct-access-to-umeda-osaka-cast.html", mapUrl: "https://www.google.com/maps/search/?api=1&query=Teradacho%20Station%20Osaka" },
    seoul: { name: "Soft Minimal 2BR Home near Dongdaemun", dates: "30.08–05.09", nights: 6, price: 2154.02, rating: "9.9", area: "Dongdaemun / Jung-gu, Seul", address: "Dongdaemun / Jung-gu · okolice Dongdaemun (dokładny adres w prywatnej notatce)", check: "16:00 / 11:00", image: "assets/images/hotels/seoul-home.webp", bookingUrl: "https://www.booking.com/hotel/kr/cozy-2br-home-near-ddp-myeongdong-dongdaemun.html", mapUrl: "https://www.google.com/maps/search/?api=1&query=Dongdaemun%20Seoul" }
  },
  destinations: {
    tokyo: {
      ...
      days: [
        { date: "21.08", day: "Piątek", title: "Lądowanie i miękki start", text: "NRT 18:25 → dojazd → zameldowanie → konbini lub ramen. Bez ambitnego zwiedzania.", cost: "¥", pace: "lekko", details: { image: "assets/images/tokyo_days/nrt.jpg", desc: "Przylot na lotnisko Narita (NRT) wieczorem. Po przejściu kontroli celnej odbierzemy bagaże i udamy się na pociąg. Omijamy drogie pociągi ekspresowe! To będzie długi dzień w podróży, więc po zameldowaniu pójdziemy do najbliższego konbini (FamilyMart/7-Eleven) po gotowe bento na kolację i szybkie śniadanie.", transport: "Z Narity jedziemy wolniejszym, ale tańszym i wygodniejszym połączeniem: pociągiem Keisei Main Line do stacji Keisei-Sekiya, tam krótki spacer na stację Ushida i 2 przystanki Tobu Skytree Line do Gotanno." } },
        { date: "22.08", day: "Sobota", title: "Nowoczesne Tokio", text: "Shibuya Crossing, Hachikō, Harajuku, Takeshita Street, Meiji Jingu, Shinjuku po zmroku i darmowy punkt widokowy w Tokyo Metropolitan Government Building.", cost: "¥", pace: "dużo chodzenia", details: { image: "assets/images/tokyo_days/shibuya.jpg", desc: "Zanurzamy się w nowoczesne i szalone Tokio! Zaczniemy od słynnego skrzyżowania Shibuya Crossing i pomnika psa Hachiko. Następnie przejdziemy do Harajuku – przejdziemy przez kolorową Takeshita Street pełną crêpes i szalonej mody, a potem odpoczniemy w leśnym kompleksie świątyni Meiji Jingu. Wieczór spędzimy w rozświetlonym neonami Shinjuku i wjedziemy na darmowy punkt widokowy Tokyo Metropolitan Government Building.", transport: "Poruszamy się głównie linią JR Yamanote (zielona pętla), która łączy Shibuyę, Harajuku i Shinjuku." } },
        { date: "23.08", day: "Niedziela", title: "Klasyka i popkultura", text: "Asakusa i Sensō-ji, Ueno oraz Akihabara — bez powrotu na zachodnią stronę miasta.", cost: "¥", pace: "średnio", details: { image: "assets/images/tokyo_days/asakusa.jpg", desc: "Dzień pełen kontrastów. Rano odwiedzimy najstarszą świątynię w Tokio – Sensō-ji w historycznej dzielnicy Asakusa. Przejdziemy przez bramę Kaminarimon i uliczkę Nakamise. Następnie udamy się przez Ueno do Akihabary – mekki elektroniki, anime i gier wideo. Wieczór zostaje na spokojny powrót lub dodatkowy czas w Akihabarze, bez cofania się do Shinjuku.", transport: "Do Asakusy dojedziemy metrem (linia Ginza lub Asakusa). Z Asakusy do Akihabary szybko dostaniemy się np. z przesiadką na stacji Ueno." } },
        { date: "24.08", day: "Poniedziałek", title: "Tokyo Disneyland", text: "Cały dzień w parku. Zarezerwowany większy budżet żywieniowy z uwagi na wysokie ceny i brak możliwości wnoszenia własnego jedzenia.", cost: "¥¥¥ (ok. 450-500 PLN)", pace: "cały dzień", must: true, details: { image: "assets/images/tokyo_days/disney.jpg", desc: "Czeka nas magiczny, całodniowy pobyt w Tokyo Disneyland! Zobaczymy Zamek Kopciuszka, klasyczne parady i mnóstwo bajkowych atrakcji. Pamiętajmy o sporym budżecie na obiad i kultowe przekąski (lody, popcorn).", transport: "Dojazd z Gotanno: Tobu Skytree do Kita-Senju, potem metro Hibiya do stacji Hatchobori i stamtąd linia JR Keiyo bezpośrednio pod stację Maihama." } },
    ...
    kansai: {
      ...
      days: [
        ...
        { date: "26.08", day: "Środa", title: "Kyoto: pocztówkowa Japonia", text: "Fushimi Inari wcześnie rano, Kiyomizu-dera, uliczki Higashiyamy i Gion wieczorem. Wypożyczenie tradycyjnych strojów dla 1 dorosłego i 2 dzieci.", cost: "¥¥", pace: "dużo chodzenia", must: true, details: { image: "assets/images/osaka_days/kyoto.jpg", desc: "Startujemy bardzo wcześnie! Kyoto to historyczna perła. Otwieramy też 3-dniowy bilet JR Kansai Mini Pass. Zaczniemy od szlaku tysięcy czerwonych bram torii w Fushimi Inari, potem świątynia Kiyomizu-dera i Gion. Wypożyczymy tradycyjne japońskie stroje dla 3 osób na zdjęcia.", transport: "Aktywujemy JR Kansai Mini Pass! Z Teradacho (przez Tennoji na Osaka Station) jedziemy szybkimi pociągami JR Special Rapid prosto do Kioto." } },
        { date: "27.08", day: "Czwartek", title: "Nara i jelonki", text: "Nara Park, Todai-ji i spokojny rodzinny spacer. Karmimy jelonki wyłącznie specjalnymi krakersami.", cost: "¥¥", pace: "średnio", must: true, details: { image: "assets/images/osaka_days/nara.jpg", desc: "Wycieczka poza miasto do dawnej stolicy – Nary. Główną atrakcją jest ogromny park, po którym swobodnie wędrują setki oswojonych jelonków sika. Zobaczymy też olbrzymią świątynię Todai-ji z wielkim Buddą. Wykorzystujemy JR Kansai Mini Pass.", transport: "Ze stacji Tennoji łapiemy pociąg Yamatoji Rapid Service prosto do stacji JR Nara (około 40-50 min)." } },
        { date: "28.08", day: "Piątek", title: "Odpoczynek: Wybrzeże Suma", text: "Ostatni dzień działania JR Kansai Mini Pass. Relaks na plaży Suma; przy deszczu plan B: Kobe Harborland lub Osaka Aquarium.", cost: "¥", pace: "lekko", details: { image: "assets/images/osaka_days/castle.jpg", desc: "Dzień odpoczynku od zgiełku miast. Wykorzystując wygasający Mini Pass, jedziemy na malownicze wybrzeże Suma (obok Kobe). Zrelaksujemy się na plaży, spróbujemy owoców morza i odpoczniemy przed drugą połową wyjazdu. Jeśli będzie ulewa lub ostrzeżenia pogodowe, zamieniamy plażę na Kobe Harborland / centrum Kobe albo Osaka Aquarium Kaiyukan.", transport: "Pełen zasięg Mini Pass: bezlimitowy kurs pociągami JR Special Rapid z Teradacho bezpośrednio na wybrzeże Suma." } },
        { date: "29.08", day: "Sobota", title: "Osaka: jedzenie i neony", text: "Okolice Namby, Dotonbori, jedzenie uliczne w południowej Osace (takoyaki, okonomiyaki).", cost: "¥¥¥", pace: "średnio", details: { image: "assets/images/osaka_days/dotonbori.jpg", desc: "Dzień pełen jedzenia i miejskiego zgiełku (tzw. Kuidaore - jedz aż padniesz). Eksploracja ulicznego jedzenia w południowej Osace. Zobaczymy słynny kanał Dotonbori, wielkiego kraba i neon Glico Man.", transport: "W obrębie Osaki opłacamy przejazdy czystymi potrąceniami z kart Suica. Z Teradacho do stacji Tennoji i węzłów miasta." } },
        { date: "30.08", day: "Niedziela", title: "Osaka → Seul", text: "Wymeldowanie do ok. 10:00, pociąg na KIX i lot do Gimpo (GMP). Lot opłacony (Peach Aviation).", cost: "opłacone", pace: "transfer", details: { image: "assets/images/osaka_days/kix.jpg", desc: "Żegnamy się z Japonią. Rano spakujemy się i opuścimy dom w Teradacho. Z kierunku Tennoji udamy się bezpośrednim pociągiem na lotnisko Kansai (KIX). Pamiętajmy o dojeździe autobusem do T2.", transport: "Z pobliskiej stacji Tennoji bierzemy Kansai Airport Rapid Service bezpośrednio na KIX (ok. 50 minut jazdy). Omijamy drogie i wymagające rezerwacji pociągi typu Haruka." } }
      ],
      restaurants: [
    ...
    seoul: {
      ...
      days: [
        { date: "30.08", day: "Niedziela", title: "Pierwszy wieczór w Korei", text: "Przylot, transfer, karty T-Money dla dzieci. Krótki wieczór w Dongdaemun.", cost: "₩₩", pace: "lekko", details: { image: "assets/images/seoul_days/dongdaemun.jpg", desc: "Z lotniska Gimpo dojedziemy metrem lub AREX All-Stop w stronę centrum. Najważniejsze po wylądowaniu: idziemy do małego sklepu (CU/GS25) na lotnisku i pokazując paszporty, wyrabiamy zniżkowe karty T-Money dla dzieci! Potem zameldujemy się w hotelu i ruszymy na kolację.", transport: "Z GMP bierzemy metro/AREX All-Stop do centrum, dalej przesiadka w stronę Dongdaemun według Naver Map." } },
        ...
        { date: "01.09", day: "Wtorek", title: "DMZ i Most Wiszący (zrobić rezerwację)", text: "Półdniowa wycieczka pod granicę (Tunel, Most). Zbiórka: Myeongdong wyj. 10 na 09:00. Link w opisie.", cost: "₩₩₩ (ok. 807 PLN)", pace: "średnio", must: true, details: { image: "assets/images/seoul_days/namsan.jpg", desc: "Do zrobienia rezerwacja: <a href='https://www.getyourguide.com/seul-l197/seul-wycieczka-do-trzeciego-tunelu-i-mostu-wiszacego-w-strefie-zdemilitaryzowanej-t63309' target='_blank' style='color: var(--brand-teal); text-decoration: underline;'>GetYourGuide DMZ Tour</a>. Zapłacić w PLN. Zbiórka o 09:00, stacja Myeongdong (wyjście 10). Pamiętajcie o paszportach i mega wygodnych butach (40 min podejścia na most)! Po powrocie spacer na wzgórze Namsan i street food.", transport: "Z Dongdaemun bardzo szybki dojazd metrem linii 4 prosto do stacji Myeongdong (ok. 8 minut jazdy)." } },
        ...
        { date: "03.09", day: "Czwartek", title: "Tradycyjny Seul i Hanboki", text: "Gyeongbokgung, Bukchon Hanok Village i Insadong. Wypożyczamy tradycyjne Hanboki!", cost: "₩₩", pace: "dużo chodzenia", details: { image: "assets/images/seoul_days/gyeongbokgung.jpg", desc: "Odkrywamy historyczną stronę Korei. Zwiedzimy największy pałac Gyeongbokgung (w hanbokach wejście do pałacu jest darmowe!), zobaczymy tradycyjne domki w wiosce Bukchon Hanok oraz przespacerujemy się artystyczną ulicą Insadong. Zrobimy mnóstwo pamiątkowych zdjęć w tradycyjnych strojach.", transport: "Najlepiej podjechać metrem linii 3 (pomarańczowa) do stacji Gyeongbokgung (wyjście 5) lub Anguk." } },
        { date: "04.09", day: "Piątek", title: "Suwon i K-BBQ", text: "Wycieczka do historycznej twierdzy Hwaseong w Suwon. Wieczorem uroczysta kolacja w formacie Korean BBQ.", cost: "₩₩₩", pace: "średnio", details: { image: "assets/images/seoul_days/hongdae.jpg", desc: "Ostatni pełny dzień zaczynamy od wycieczki do pobliskiego Suwon, by zobaczyć imponującą twierdzę Hwaseong (UNESCO). Po powrocie celowo powiększony budżet (ok. 310 PLN) przeznaczamy na autentyczne, finałowe doświadczenie przy grillu z wieprzowiną w lokalnej restauracji K-BBQ.", transport: "Do Suwon dojeżdża bezpośrednio linia metra nr 1, podróż zajmuje ok. godziny. Koszty opłacane z zapasów T-Money." } },
  ...
  budget: {
    ...
    envelopes: [
      ...
      { label: "Transport lokalny", amount: 1150, icon: "🚇" },
  ...
  todos: [
    ...
    { title: "Karty IC dla dzieci", detail: "Japonia: Welcome Suica wyrabiane u urzędnika z paszportem! Korea: T-Money w CU/GS25 na lotnisku (też z paszportem).", priority: "high", category: "transport" },
    { title: "Kupić JR Kansai Mini Pass", detail: "Zrobić przed Kansai. Porównać sumę: Teradacho–Kyoto RT + Teradacho–Nara RT + Teradacho–Suma RT z ceną passu.", priority: "high", category: "transport" },
